...
describe('unexpected-react-shallow', function () {
    ...
    describe('to render as', function () {
        ...
        it('provides the rendered component as the fulfillment value', function () {
            return expect(React.createElement(FunctionComp, null), 'to render as', React.createElement('div', null)).then(function (functionComp) {
                return expect(functionComp, 'to be a', 'ReactShallowRenderer');
            });
        });
    });
    ...
    describe('with component returning array', function () {
        ...
        describe('to render as', function () {
            ...
            it('passes when it matches', function () {
                expect(React.createElement(TestArray, null), 'to render as', [React.createElement(
                    'div',
                    { className: 'foo bar' },
                    'one'
                ), React.createElement(
            ...
            it('errors for each failing element', function () {
                expect(function () {
                    return expect(React.createElement(TestArray, null), 'to render as', [React.createElement(
                        'div',
                        { className: 'baz foo' },
                        'one'
                    ), React.createElement(
                ...
                }, 'to throw', ['expected <TestArray />', 'to render as [ <div className="baz foo">one</div>, <div>three</div> ]', '', '[', '  <div className="foo bar">one</div>, // should have rendered <div className="baz foo">one</div>', '                                      //', '                                      // <div className="foo bar" // missing class \'baz\'', '                                      // >', '                                      //   one', '                                      // </div>', '  <div>two</div> // should have rendered <div>three</div>', '                 //', '                 // <div>', '                 //   two // -two', '                 //       // +three', '                 // </div>', ']'].join('\n'));
            });

            it('passes the flags for each element', function () {
                expect(function () {
                    return expect(React.createElement(TestArray, null), 'to render with all classes as', [React.createElement(
                        'div',
                        { className: 'foo' },
                        'one'
                    ), React.createElement(
                ...
                }, 'to throw', ['expected <TestArray />', 'to render with all classes as [ <div className="foo">one</div>, <div>two</div> ]', '', '[', '  <div className="foo bar">one</div>, // should have rendered with all classes <div className="foo">one</div>', '                                      //', '                                      // <div className="foo bar" // extra class \'bar\'', '                                      // >', '                                      //   one', '                                      // </div>', '  <div>two</div>', ']'].join('\n'));
            });
        });
        ...
        describe('to have rendered', function () {
            ...
            beforeEach(function () {
                renderer = createRenderer();
                renderer.render(React.createElement(TestArray, null));
            });
            ...
            it.skip('passes the flags for each element', function () {
                expect(function () {
                    return expect(renderer, 'to have rendered with all classes', [React.createElement(
                        'div',
                        { className: 'foo' },
                        'one'
                    ), React.createElement(
